...
namespace rz {
namespace config {
constexpr std::string_view PROJECT_NAME = "md_fe_desktop";
constexpr std::string_view PROG_LONGNAME = "Desktop frontend for MitM medical devices";
constexpr std::string_view PROJECT_DESCRIPTION = "Desktop frontend for MitM medical devices";
